...
#define COMMON_REPO "testrepo-with-subdir-worktree"
#define WORKTREE_REPO "dir/testrepo-worktree-subdir"

static worktree_fixture fixture =
	WORKTREE_FIXTURE_INIT(COMMON_REPO, WORKTREE_REPO);

void test_worktree_subdir__initialize(void)
{
	setup_fixture_worktree(&fixture);
}

void test_worktree_subdir__cleanup(void)
{
	return;
	/* cleanup_fixture_worktree(&fixture); */
}

void test_worktree_subdir__list(void)
{
	git_strarray wts;
...
/* void test_worktree_subdir__list_with_invalid_worktree_dirs(void) */
/* { */
...
/* void test_worktree_subdir__list_in_worktree_repo(void) */
/* { */
/* 	git_strarray wts; */
...
/* void test_worktree_subdir__list_without_worktrees(void) */
/* { */
/* 	git_repository *repo; */
/* 	git_strarray wts; */
...
/* void test_worktree_subdir__lookup(void) */
/* { */
/* 	git_worktree *wt; */
...
/* /1* void test_worktree_subdir__lookup_nonexistent_worktree(void) *1/ */
/* /1* { *1/ */
/* /1* 	git_worktree *wt; *1/ */

/* /1* 	cl_git_fail(git_worktree_lookup(&wt, fixture.repo, "nonexistent")); *1/ */
/* /1* 	cl_assert_equal_p(wt, NULL); *1/ */
/* /1* } *1/ */

/* void test_worktree_subdir__open(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* void test_worktree_subdir__open_invalid_commondir(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* void test_worktree_subdir__open_invalid_gitdir(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
/* 	git_str buf = GIT_STR_INIT, path = GIT_STR_INIT; */
...
/* void test_worktree_subdir__open_invalid_parent(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* void test_worktree_subdir__init(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* 	/1* Open and verify created repo *1/ */
...
/* void test_worktree_subdir__add_locked(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
/* 	git_reference *branch; */
...
/* void test_worktree_subdir__init_existing_branch(void) */
/* { */
...
/* void test_worktree_subdir__add_with_explicit_branch(void) */
/* { */
...
/* 	/1* fprintf(stderr, "IN TEST | calling git_worktree_add()\n"); *1/ */
/* 	cl_git_pass(git_worktree_add(&wt, fixture.repo, "worktree-with-different-name", path.ptr, &opts)); */
/* 	/1* fprintf(stderr, "IN TEST | worktree added\n"); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | gitdir path:    %s\n", wt->gitdir_path); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | commondir path: %s\n", wt->commondir_path); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | worktree path:   %s\n", wt->worktree_path); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | git_repository_open_from_worktree()\n"); *1/ */
/* 	cl_git_pass(git_repository_open_from_worktree(&wtrepo, wt)); */
/* 	/1* fprintf(stderr, "IN TEST | worktree opened\n"); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | gitdir path:    %s\n", wtrepo->gitdir); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | commondir path: %s\n", wtrepo->commondir); *1/ */
/* 	/1* fprintf(stderr, "IN TEST | workdir path:   %s\n", wtrepo->workdir); *1/ */
...
/* void test_worktree_subdir__add_no_checkout(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *wtrepo; */
/* 	git_index *index; */
...
/* void test_worktree_subdir__init_existing_worktree(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_str path = GIT_STR_INIT; */
...
/* void test_worktree_subdir__init_existing_path(void) */
/* { */
...
/* 	/1* Delete files to verify they have not been created by */
/* 	 * the init call *1/ */
...
/* 	/1* Verify files have not been re-created *1/ */
/* 	for (i = 0; i < ARRAY_SIZE(wtfiles); i++) { */
/* 		cl_git_pass(git_str_joinpath(&path, */
/* 			    fixture.worktree->gitdir, wtfiles[i])); */
...
/* void test_worktree_subdir__init_submodule(void) */
/* { */
...
/* void test_worktree_subdir__validate(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__name(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__path(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__validate_invalid_commondir(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__validate_invalid_gitdir(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__validate_invalid_parent(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__lock_with_reason(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__lock_without_reason(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_buf reason = GIT_BUF_INIT; */
...
/* void test_worktree_subdir__unlock_unlocked_worktree(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__unlock_locked_worktree(void) */
/* { */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__prune_without_opts_fails(void) */
/* { */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* 	/1* Assert the repository is still valid *1/ */
/* 	cl_git_pass(git_repository_open_from_worktree(&repo, wt)); */
...
/* void test_worktree_subdir__prune_valid(void) */
/* { */
...
/* 	/1* Assert the repository is not valid anymore *1/ */
/* 	cl_git_fail(git_repository_open_from_worktree(&repo, wt)); */
...
/* void test_worktree_subdir__prune_locked(void) */
/* { */
/* 	git_worktree_prune_options opts = GIT_WORKTREE_PRUNE_OPTIONS_INIT; */
/* 	git_worktree *wt; */
/* 	git_repository *repo; */
...
/* void test_worktree_subdir__prune_gitdir_only(void) */
/* { */
/* 	git_worktree_prune_options opts = GIT_WORKTREE_PRUNE_OPTIONS_INIT; */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__prune_worktree(void) */
/* { */
/* 	git_worktree_prune_options opts = GIT_WORKTREE_PRUNE_OPTIONS_INIT; */
/* 	git_worktree *wt; */
...
/* void test_worktree_subdir__foreach_worktree_lists_all_worktrees(void) */
/* { */
/* 	int counter = 0; */
/* 	cl_git_pass(git_repository_foreach_worktree(fixture.repo, foreach_worktree_cb, &counter)); */
/* } */

/* void test_worktree_subdir__validate_invalid_worktreedir(void) */
/* { */
/* 	git_worktree *wt; */
